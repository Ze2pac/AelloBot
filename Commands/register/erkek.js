...
exports.run = async (client, message, args) => {
  ...
  await member.roles.add(Config.Roles.Male)
...
**Kayıt türü:** __Erkek__ 
**Kayıt edilen isim:** __${args.slice(1).join(' ') ? args.slice(1).join(' ') : 'İSİMSİZ İŞLEM'}__
**Katılım Tarihi** __${moment.utc(member.joinedAt).format('** HH.mm - DD.MM.YY **')}__

**Kayıt Tarihi:** __${moment(Date.now()).format("** HH.mm - DD.MM.YY **")}__
............................`)

  message.channel.send(new Discord.MessageEmbed().setColor('2F3136').setTitle('Erkek Kayıt İşlemi Başarılı!').setDescription(`**Kayıt eden yetkili: ${message.author}**\n\n**Kayıt Edilen Üye: ${member}**`)
  ...
  client.channels.cache.get(Config.Channels.KayitLog).send(new Discord.MessageEmbed().setColor('2F3136').setTitle('Erkek Kayıt İşlemi Yapıldı')
