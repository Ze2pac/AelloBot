...
exports.run = async (client, message, args) => {
  ...
  await member.roles.add(Config.Roles.Female)
...
**Kayıt türü:** __Kadın__ 
**Kayıt edilen isim:** __${args.slice(1).join(' ')}__
**Tarih:** __${moment(Date.now() + 1000 * 60 * 60 * 3).format("** HH.mm - DD.MM.YY **")}__`)

  message.channel.send(new Discord.MessageEmbed().setColor('2F3136').setTitle('Kadın Kayıt İşlemi Başarılı!').setDescription(`**Kayıt eden yetkili: ${message.author}**\n\n**Kayıt Edilen Üye: ${member}**`)
  ...
  client.channels.cache.get(Config.Channels.KayitLog).send(new Discord.MessageEmbed().setColor('2F3136').setTitle('Kadın Kayıt İşlemi Yapıldı')
